...
// const BannerContent = () => {
//   return (
//     <div className='max-w-[1024px] mx-auto pt-10 px-8 lg:px-0 mt-[120px]'>
//         <div className=' flex-wrap justify-center items-justify h-[25px]  mt-[100px]'>
...
//                 <p className='text-white text-[12px] md:text-[16px] w-[600px]'>In augue ligula, feugiat ut nulla consequat. Ut est lacus, molestie in arcu 
